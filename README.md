...
| [`archimate-lite`](archimate-lite/) | 3.1.0 | ArchiMate subset (L0–L4), allowed matrix, Open Exchange notes |
...
2. `archimate-lite/releases/archimate-lite-3.1.0.bundle.json`
