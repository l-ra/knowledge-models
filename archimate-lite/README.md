...
| [releases/archimate-lite-3.0.0.bundle.json](releases/archimate-lite-3.0.0.bundle.json) | Aktuální bundle |
...
2. Tento package `releases/archimate-lite-3.0.0.bundle.json`
3. [`archimate-ui-traversal` 1.0.0](../archimate-ui-traversal/releases/archimate-ui-traversal-1.0.0.bundle.json)

**Neimportujte** 3.0.0 přes existující 2.3.1 (`compat_breaking` — UI objekty v 3.0.0 chybí).
